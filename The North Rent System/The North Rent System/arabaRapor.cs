...
{
    public partial class arabaRapor : Form
    {
        DBOClass kullanici;
        DataTable sqlData;
        ...
        private void arabaRapor_Load(object sender, EventArgs e)
        {
            try
            {
                kullanici.baglantiS.Open();
                kullanici.Listele("aracEkle");
                TabloYenileme("aracEkle");
        ...
        private void TabloYenileme(string tabloName)
        {
            ...
            arabaRaporTablo.AllowUserToAddRows = false;
            arabaRaporTablo.AllowUserToDeleteRows = false;
            arabaRaporTablo.ReadOnly = true;
            arabaRaporTablo.DataSource = sqlData;
        }
        ...
        private void pdfExport_Click(object sender, EventArgs e)
        {
            ...
            TabloYenileme("aracEkle"); //Veri tabanından tabloyu çekmek için
            exportGrid(arabaRaporTablo, "Araba Listesi " + thisDay);
